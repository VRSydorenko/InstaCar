...
- (void)initialize {
    ...
    CGSize loginTextSize = [[self logInText] sizeWithAttributes: @{NSFontAttributeName: font}];
    CGSize logoutTextSize = [[self logOutText] sizeWithAttributes: @{NSFontAttributeName: font}];
    float textSizeWidth = MAX(loginTextSize.width, logoutTextSize.width);
